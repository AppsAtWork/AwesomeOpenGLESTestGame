 ...
 */
public class AtlasSprite extends OpenGLObject
{
    ...
    public AtlasSprite(TextureAtlas atlas, int textureIndex, float centerX, float centerY, float width, float height)
    {
        Atlas = atlas;
    ...
    {
        if(TextureManagement.ResendAtlasses)
        {
            TextureManagement.SendAtlasses();
            TextureManagement.ResendAtlasses = false;
        }
    ...
    {
        uvs = Atlas.GetUVCoords(TextureIndex);
